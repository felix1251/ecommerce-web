...
const Banner: React.FunctionComponent = () => {
  return (
    <div className="bg-secondary w-full hidden items-center min-h-14 lg-2:flex">
      <div className="flex margin-min-screen justify-between gap-5 text-white font-medium">
